            ...
            <div className="hidden md:flex flex-col justify-between w-1/2 p-12 bg-gradient-to-b from-[#0b3d82] to-[#05214d]">
                <div>
                    <div className="flex items-center space-x-3">
                        <div className="bg-[#e95723] text-white font-bold p-2 rounded-lg text-xl w-10 h-10 flex items-center justify-center">
                            C
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-300">
                                Content Marcom Engagement & Tracking System
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-24 max-w-lg">
                        <h2 className="text-4xl font-bold leading-tight mb-6">
                            Kelola Request Konten dengan Mudah & Efisien
                        </h2>
                ...
                <div className="bg-white text-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-md">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#e95723] hover:bg-[#d44b1c] disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-bold py-2.5 rounded-lg transition duration-200"
                        >
